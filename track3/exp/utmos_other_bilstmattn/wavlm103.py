...
VERSION = "01314"
EXP_ID = "utmos_sslwavlm_sf_bilstmattention"
...
# model
cfg.model.model_name = "wavlm_bilstmattention"
...
# loss
cfg.loss.l1_rate_min = 0.9
cfg.loss.l1_rate_max = 0.9
cfg.loss.cl_rate = 0.1  # 順序にはこっちがきく
cfg.loss.diff_rate = 0.1  # l1が安定
