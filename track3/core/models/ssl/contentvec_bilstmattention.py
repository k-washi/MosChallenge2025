...
from transformers import HubertModel  # pyright: ignore[reportPrivateImportUsage]

from track3.core.models.modules.bilstmattention import BiLSTMWithAttention


class MOSPredictorContentVec(nn.Module):
    ...
    def __init__(
        ...
        pretrained_model_name: str = "lengyue233/content-vec-best",
        lstm_layrs: int = 3,
        ...
        self.ssl_model = HubertModel.from_pretrained(pretrained_model_name)
