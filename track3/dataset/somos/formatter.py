...
def format_dataset(dataset_dir, output_dir):
    ...
    set_rel_path = "training_files/split1/clean"
    
    user_map = format_process(
        info_csv=str(data_dir / set_rel_path / "TRAINSET"),
        wav_dir=str(data_dir / "audios"),
    ...
    user_map = format_process(
        info_csv=str(data_dir / set_rel_path / "VALIDSET"),
        wav_dir=str(data_dir / "audios"),
        output_dir=str(output_dir),
    ...
    user_map = format_process(
        info_csv=str(data_dir / set_rel_path / "TESTSET"),
        wav_dir=str(data_dir / "audios"),
        output_dir=str(output_dir),
